...
namespace server.Controllers
{
    ...
    {
        public static List<Lecturer> lecturers = new List<Lecturer> { new Lecturer("aaa","aaa","aaa@gmail.com","ddd"), new Lecturer("bbb", "bbb", "Ruth@gmail.com", "111111") };
        ...
        {
            var lec=lecturers.Find(x => x.UserName == name);
            if (lec != null)
                return lec;
            return null;
        }
